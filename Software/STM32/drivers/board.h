...
//#define APP_VERSION 14	//自增内容,使用的是V5.1
#define APP_VERSION 38	//自增内容,使用的是V5.2，V5.2的版本为20+，V6.0版本，则为30+
...
#define BSP_I2C1_SCL_PIN    GET_PIN(B, 6) //GET_PIN(B, 6)
#define BSP_I2C1_SDA_PIN    GET_PIN(B, 7) //GET_PIN(B, 7)
#endif
...
#define BSP_USING_PWM1_CH2	//LB_PWM
#define BSP_USING_PWM1_CH4	//LF_PWM
